  ...
  return (
    <section className='bg-[var(--background)] px-6 py-10 sm:px-10 lg:py-14'>
      ...
      <p className='mx-auto mt-3 max-w-2xl text-center text-zinc-600 lg:text-lg'>
        <strong>Джиневер </strong> має чистий, гармонійний смак із вираженими
        хвойними нотами та свіжим цитрусовим післясмаком. Використання виключно
        власної зернової основи забезпечує напою особливу м&apos;якість та
        глибину.
      </p>
